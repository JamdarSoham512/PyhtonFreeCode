...
Define employee_code as 'DEV-2026-JD-001'. After that, create a variable department and assign it the slice of employee_code from index 0 to 3. Then print 
...
Finally, print both variables to the 
